...
![Pokédex 2.0](../images/cours/bts-2/90/pokedex_full.jpg)

+ [x] Recueillir le besoin (prise de notes)
...
+ [ ]  Prendre en compte les contraintes techniques
    ...
    + [ ] Description du mécanisme de cache

    + [ ] Schématisation de l'impact dans les [diagrammes de séquence](https://lipn.univ-paris13.fr/~gerard/uml-s2/uml-cours05.html)