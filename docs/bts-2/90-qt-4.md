...
Le recueil du besoin est réalisé à l'oral (prise de notes).
...
-   :material-human-male-board:{ .lg .middle } __Diagramme de séquence macro__
    ...
    ![Icone](../images/cours/bts-2/90/pookedex/tableau_diagramme_sequence_macro.jpg)
...
-   :material-human-male-board:{ .lg .middle } __Options de cache__
    ...
    ![Icone](../images/cours/bts-2/90/pookedex/tableau_options_cache.jpg)
...
-   :material-human-male-board:{ .lg .middle } __Choix cache et webservices__
    ...
    ![Icone](../images/cours/bts-2/90/pookedex/tableau_webservices_cache.jpg)
...
-   :material-human-male-board:{ .lg .middle } __Diagramme de classes__
    ...
    ![Icone](../images/cours/bts-2/90/pookedex/tableau_diagramme_classes.jpg)
